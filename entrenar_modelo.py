...
dfn=pd.read_csv("C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/delitos_minable.csv")


codEdad=preprocessing.LabelEncoder()
dfn['RangoEdad']=codEdad.fit_transform(dfn['RangoEdad'])
print(codEdad.classes_)
jb.dump(codEdad,'C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/codEdad.bin')


codHorario=preprocessing.LabelEncoder()
dfn['rangoHORARIO']=codHorario.fit_transform(dfn['rangoHORARIO'])
print(codHorario.classes_)
jb.dump(codHorario,'C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/codHorario.bin')


codComuna=preprocessing.LabelEncoder()
dfn['NOM_COM']=codComuna.fit_transform(dfn['NOM_COM'])
print(codComuna.classes_)
jb.dump(codComuna,'C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/codComuna.bin')

codDia=preprocessing.LabelEncoder()
dfn['DIA_NOMBRE']=codDia.fit_transform(dfn['DIA_NOMBRE'])
print(codDia.classes_)
jb.dump(codDia,'C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/codDia.bin')


codGenero=preprocessing.LabelEncoder()
dfn['GENERO']=codGenero.fit_transform(dfn['GENERO'])
print(codGenero.classes_)
jb.dump(codGenero,'C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/codGenero.bin')
...
jb.dump(modeloBA,"C:/Users/USUARIO/Documents/UNAB/inteligenciaArtificial/delitos/modeloBA.bin")
